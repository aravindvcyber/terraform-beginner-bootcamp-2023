...
- [Terraform Beginner Bootcamp 2023 - Week 0](#terraform-beginner-bootcamp-2023---week-0)
  ...
  - [Terraform remove environment variables](#terraform-remove-environment-variables)

## Semantic Versioning :rocket:
...
```json
{
    ...
    "Arn": "arn:aws:iam::123456789012:user/gitpod-tf-user-cpb"
}
```
